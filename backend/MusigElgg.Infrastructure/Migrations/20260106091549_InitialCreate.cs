    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InventoryLoans", x => x.Id);
                    table.ForeignKey(
                        name: "FK_InventoryLoans_InventoryItems_InventoryItemId",
                        column: x => x.InventoryItemId,
                        principalTable: "InventoryItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_InventoryLoans_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RoleChangeRequests_Roles_NewRoleId",
                        column: x => x.NewRoleId,
                        principalTable: "Roles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RoleChangeRequests_Users_ApprovedByUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InventoryLoans_InventoryItemId",
                table: "InventoryLoans",
                column: "InventoryItemId");

            migrationBuilder.CreateIndex(
                name: "IX_InventoryLoans_UserId",
                table: "InventoryLoans",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoleChangeRequests_ApprovedByUserId",
                table: "RoleChangeRequests",
                column: "ApprovedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_RoleChangeRequests_NewRoleId",
                table: "RoleChangeRequests",
                column: "NewRoleId");
